 ...
 <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Bricks MFG Co.</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul id="logout" class="nav navbar-nav navbar-right">  
                        <button type="button" id="logout_button" data-toggle="dropdown" class="btn btn-info navbar-btn"><i class="glyphicon glyphicon-user"></i> Logout</button>     
                </ul>
